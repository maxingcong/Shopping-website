 ...
 */
require(["base", "tools", "product/detail_tpl", "product/params_201", "product/price", "product/config/201"], function ($, T, ProductDetail, ProductParams, ProductPrice, ProductConfig){
    T.Loader(function() {
